...
const Home = () => {
  return (
    <div>
      ...
      <a href="/shopping-cart/harryPotter">
      <div
      ...
      <a href="/shopping-cart/breakingBad">
      <div
